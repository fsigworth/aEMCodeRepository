function X = swt16rec3(wdec,varargin)
%swt16rec3 
...
filtersorig = wdec.filters;

if (nbREC_UP==2)
  
  cfsALP = cell(15,1);
  cfsALP(1:8,1)  = cfs(1:8,1);
  cfsALP(9:15,1) = cfs(10:16,1);
  
  evenoddVal = 0;
  idxBeg = 1;
  for k=1:nbREC_UP
    idxEnd = idxBeg+7;
    wdec.dec = reshape(cfsALP(idxBeg:idxEnd),2,2,2);
