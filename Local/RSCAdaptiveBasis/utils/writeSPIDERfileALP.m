function writeSPIDERfileALP(filename, data, varargin)
...
header = makeSPIDERheaderALP(datasize, stackarg);
if header < 0
...
function header=makeSPIDERheaderALP(datasize, stackarg)
