function [H1, rs]=k2GetWeightingFilter3(wI,wIMean,wISpec,minSNR,displayOn)
...
dsw=4;  % assumed downsampling of wI, wIMean for labeling graphs
...
rs.csv1=csv1;
f=(1:numel(csr1))';
w0=f.*csr1./csv1;   % initial 1D weighting function W(f)
w0(1)=0;
