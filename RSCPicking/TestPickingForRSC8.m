% function TestPickingForRSC8 %(m,mi,map,mapPixA)
...
% map=Crop(map,nt)*5.8*ds1;  % approx. amplitude correction (V-A scaling)
% save([basePath 'AMPARMap24.mat'],'map');
% %%
load([basePath 'AMPARMap24.mat']);  % load map
nt=size(map,1);
