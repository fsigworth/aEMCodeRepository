function [v,wi]=gpuVesicleFromRings(n,exPos,exSigma,r,org,exAmps)
...
vArray=zeros(n2,nxc,'single','gpuArray');
...
for i=1:nxc
    ...
    vArray(:,i)=reshape(gpuVesicleFromModelGeneral(n1,r,vdx,org1),n2,1);
end;
