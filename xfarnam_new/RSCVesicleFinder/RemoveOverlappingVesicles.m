function miOut=RemoveOverlappingVesicles(mi)
% CheckVesicleOverlaps
ovThresh=.3;  % threshold of total membrane area for being an overlap
...
% vesOk(~vesOk(:,1),:)=[]; % any unfound vesicle is zeroed completely.
% but we'd need to do this for all fields of mi.vesicle!
