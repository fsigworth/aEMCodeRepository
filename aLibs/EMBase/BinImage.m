...
% is cropped first.  Rectangular images are handled correctly, and nb may be
% a two-element vector.  out is always returned as a single.
...
if dims> 1 && numel(nb)<2  % if nb is a scalar, make it a vector
    nb=nb(1)*ones(1,2);
end;
