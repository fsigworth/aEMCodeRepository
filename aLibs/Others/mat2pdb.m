%% -- mat2PDB.m --
% *** outfile is name of output file. Default is mat2PDB.pdb  ***
%
% fs modified to use input.restOfLine for characters after Z coordinate.
%
...
%
% or:
% input.restOfLine     cell array of strings
%
% -- example uses --
%
...
useRest=isfield(input,'restOfLine');
