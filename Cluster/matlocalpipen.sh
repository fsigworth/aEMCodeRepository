# matlocalpipen numNodeJobs scriptName
#  launch numNodeJobs instances of a script.
#  defaults for arguments are numNodeJobs=4, scriptName = k2DistributedPipeline.m
...
do
	...
	/usr/local/cluster/software/matlab-2014a/bin/matlab -r $exec &
